...
namespace TechnomediaLabs.Internal
{
	...
	internal static class SceneViewBookmarkHotkeys
	{
		...
		[MenuItem("Zetcil/Bookmarks/Bookmark Scene View 1 &1", false, 00)]
		private static void BookmarkSceneView1()
		{
			BookmarkSceneView(1);
		}

		[MenuItem("Zetcil/Bookmarks/Bookmark Scene View 2 &2", false, 00)]
		private static void BookmarkSceneView2()
		{
			BookmarkSceneView(2);
		}

		[MenuItem("Zetcil/Bookmarks/Bookmark Scene View 3 &3", false, 00)]
		private static void BookmarkSceneView3()
		{
			BookmarkSceneView(3);
		}

		[MenuItem("Zetcil/Bookmarks/Bookmark Scene View 4 &4", false, 00)]
		private static void BookmarkSceneView4()
		{
			BookmarkSceneView(4);
		}

		[MenuItem("Zetcil/Bookmarks/Bookmark Scene View 5 &5", false, 00)]
		private static void BookmarkSceneView5()
		{
			BookmarkSceneView(5);
		}

		[MenuItem("Zetcil/Bookmarks/Bookmark Scene View 6 &6", false, 00)]
		private static void BookmarkSceneView6()
		{
			BookmarkSceneView(6);
		}

		[MenuItem("Zetcil/Bookmarks/Bookmark Scene View 7 &7", false, 00)]
		private static void BookmarkSceneView7()
		{
			BookmarkSceneView(7);
		}

		[MenuItem("Zetcil/Bookmarks/Bookmark Scene View 8 &8", false, 00)]
		private static void BookmarkSceneView8()
		{
			BookmarkSceneView(8);
		}

		[MenuItem("Zetcil/Bookmarks/Bookmark Scene View 9 &9", false, 00)]
		private static void BookmarkSceneView9()
		{
			BookmarkSceneView(9);
		}

		[MenuItem("Zetcil/Bookmarks/Move Scene View To Bookmark 1 #1", false, 01)]
		private static void MoveSceneViewToBookmark1()
		{
			RestoreSceneBookmark(1);
		}

		[MenuItem("Zetcil/Bookmarks/Move Scene View To Bookmark 2 #2", false, 01)]
		private static void MoveSceneViewToBookmark2()
		{
			RestoreSceneBookmark(2);
		}

		[MenuItem("Zetcil/Bookmarks/Move Scene View To Bookmark 3 #3", false, 01)]
		private static void MoveSceneViewToBookmark3()
		{
			RestoreSceneBookmark(3);
		}

		[MenuItem("Zetcil/Bookmarks/Move Scene View To Bookmark 4 #4", false, 01)]
		private static void MoveSceneViewToBookmark4()
		{
			RestoreSceneBookmark(4);
		}

		[MenuItem("Zetcil/Bookmarks/Move Scene View To Bookmark 5 #5", false, 01)]
		private static void MoveSceneViewToBookmark5()
		{
			RestoreSceneBookmark(5);
		}

		[MenuItem("Zetcil/Bookmarks/Move Scene View To Bookmark 6 #6", false, 01)]
		private static void MoveSceneViewToBookmark6()
		{
			RestoreSceneBookmark(6);
		}

		[MenuItem("Zetcil/Bookmarks/Move Scene View To Bookmark 7 #7", false, 01)]
		private static void MoveSceneViewToBookmark7()
		{
			RestoreSceneBookmark(7);
		}

		[MenuItem("Zetcil/Bookmarks/Move Scene View To Bookmark 8 #8", false, 01)]
		private static void MoveSceneViewToBookmark8()
		{
			RestoreSceneBookmark(8);
		}

		[MenuItem("Zetcil/Bookmarks/Move Scene View To Bookmark 9 #9", false, 01)]
		private static void MoveSceneViewToBookmark9()
		{
			RestoreSceneBookmark(9);
		}

		[MenuItem("Zetcil/Bookmarks/Return To Previous Scene View #0", false, 02)]
