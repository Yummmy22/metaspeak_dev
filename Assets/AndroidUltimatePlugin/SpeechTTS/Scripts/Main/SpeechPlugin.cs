      ...
      /*  public void Init()
        {
            ...
            {
                Utils.Message(TAG, "Speech Recognizer is already initialized calling this method is useless");
            }
        }*/
        ...
        public void Init()
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                ...
                speechCallback.onReadyForSpeech = onSpeechRecognizerReadyForSpeech;
                speechCallback.onBeginningOfSpeech = onSpeechRecognizerBeginningOfSpeech;
                speechCallback.onEndOfSpeech = onSpeechRecognizerEndOfSpeech;
                speechCallback.onError = onSpeechRecognizerError;
                speechCallback.onResults = onSpeechRecognizerResults;
                speechCallback.onPartialResults = onSpeechRecognizerPartialResults;
                speechCallback.onShowExtraSupportedLanguage = onSpeechRecognizerShowExtraSupportedLanguage;
                speechCallback.onSpeechSearchComplete = onSpeechSearchComplete;
                speechCallback.onSpeechSearchFail = onSpeechSearchFail;
                
                jo.CallStatic("init",currentActivity,speechCallback);
                hasInit = true;
        ...
        public void SetCallingPackage(string val)
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                ...
                Utils.Message(TAG, "setCallingPackage");
            }
            else
            {
                Utils.Message(TAG, "warning: must run in actual android device");
        ...
        public void EnableOffline(bool val)
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                ...
                Utils.Message(TAG, "enableOffline");
            }
            else
            {
                Utils.Message(TAG, "warning: must run in actual android device");
        ...
        public void EnablePartialResult(bool val)
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                ...
                Utils.Message(TAG, "enablePartialResult");
            }
            else
            {
                Utils.Message(TAG, "warning: must run in actual android device");
        ...
        )
        {
            ...
            if (Application.platform == RuntimePlatform.Android)
            {
                jo.CallStatic("startListeningWithExtraSetting", numberOfResults, speechMinimumLengthInMillis,
                    speechWaitingTimeInMillis);
            }
            else
            {
                Utils.Message(TAG, "warning: must run in actual android device");
